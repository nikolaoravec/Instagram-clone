      ...
      >  
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed insert-0 bg-gray-500 bg-opacity-75 transition-opacity" />
          </Transition.Child>
          {/* This is a trick the browser into centering the modal content */}
          <span
          ...
          >
            <div
             ...
             shadow-xl trasform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6"
            >
